...
class TopicService {
    ...
    async getTopicsOfSearch(termId: string, keywords: string) {
        const searchField = "name"
        return await axiosConfig.get<AxiosResponse, any>(`${this.endpoint}/query?termId=${termId}&keywords=${keywords}&searchField=${searchField}`)
    }
